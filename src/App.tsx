    ...
    >
      ...
      >
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          {/* Logo */}
          <a
            className={`flex text-2xl gap-2 font-semibold items-center justify-center ${
          ...
          <div
            className={`hidden md:flex space-x-6 rounded-lg px-8 py-4 text-xl ${
              darkMode ? 'bg-gray-800' : 'bg-[#e9fff0]'
            }`}
          >
            {navLinks.map((link) => (
              <motion.a
                ...
                className={`text-sm font-medium transition-colors duration-300 ${
                  darkMode ? 'text-green-300 hover:text-green-400' : 'text-green-600 hover:text-green-500'
                }`}
          ...
          <Button
            variant="outline"
            size="icon"
            className={`md:hidden rounded-full backdrop-blur-sm transition-all duration-300 ${
              darkMode
          ...
          >
            <Button
              variant="outline"
              size="icon"
              className={`rounded-full backdrop-blur-sm shadow-md transition-all duration-300 ${
                darkMode
                  ? 'bg-gray-900/50 hover:shadow-green-500'
                  : 'bg-white/50 hover:shadow-green-300'
              }`}
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <Button
              variant="outline"
              size="icon"
              className={`mt-4 rounded-full backdrop-blur-sm transition-all duration-300 ${
                darkMode
                  ? 'bg-gray-900/50 hover:shadow-green-500'
                  : 'bg-white/50 hover:shadow-green-300'
              }`}
      ...
      <section
        id="hero"
        className={`relative text-center overflow-x-hidden bg-gradient-to-r py-24 md:py-32 ${
          darkMode
      ...
      >
        ...
        >
          ...
          >
            ...
            <Button
              asChild
              size="lg"
              className={`transition-all duration-300 hover:shadow-lg border-2 flex gap-1 ${
                darkMode
                  ? 'bg-gray-800 text-green-300 border-green-400 hover:bg-gray-700 hover:shadow-green-500'
                  : 'bg-white text-green-600 border-green-500 hover:bg-gray-100 hover:shadow-green-300'
              }`}
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className={`mt-12 p-6 rounded-lg shadow-lg max-w-3xl mx-auto ${
              darkMode ? 'bg-gray-800/80 shadow-green-500' : 'bg-white/80 shadow-green-700'
        ...
        {isChatOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            transition={{ duration: 0.3 }}
            className={`fixed bottom-16 right-4 w-80 rounded-lg shadow-lg p-4 ${
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[
            ...
            >
              <Card
                className={`border-none shadow-lg transition-all duration-300 min-h-[200px] ${
                  darkMode
